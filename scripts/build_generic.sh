...
$GOEXEC build -v -o $output_dir/bin/generic_json_fallback_10KB_reciever $generic_dir/json/server/fallback/small
$GOEXEC build -v -o $output_dir/bin/generic_json_fallback_10KB_reciever $generic_dir/json/server/fallback/medium
