...
func (m *RpcxMsg) Reset()         { *m = RpcxMsg{} }
func (m *RpcxMsg) String() string { return proto.CompactTextString(m) }
func (*RpcxMsg) ProtoMessage()    {}
func (*RpcxMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_bf7d8c8c134b619d, []int{0}
}
func (m *RpcxMsg) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RpcxMsg) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RpcxMsg.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *RpcxMsg) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RpcxMsg.Merge(m, src)
}
func (m *RpcxMsg) XXX_Size() int {
	return m.Size()
}
func (m *RpcxMsg) XXX_DiscardUnknown() {
	xxx_messageInfo_RpcxMsg.DiscardUnknown(m)
}

var xxx_messageInfo_RpcxMsg proto.InternalMessageInfo

func (m *RpcxMsg) GetMsg() string {
	if m != nil {
		return m.Msg
	}
	return ""
...
func init() {
	proto.RegisterType((*RpcxMsg)(nil), "rpcx.RpcxMsg")
}
...
func (m *RpcxMsg) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *RpcxMsg) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RpcxMsg) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RpcxMsg) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: RpcxMsg: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RpcxMsg: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
