...
func (p *EchoServerClient) TestObj(ctx context.Context, req *ObjReq) (r *ObjResp, err error) {
	var _args EchoServerTestObjArgs
	_args.Req = req
	var _result EchoServerTestObjResult
...
func NewEchoServerProcessor(handler EchoServer) *EchoServerProcessor {
	...
	self.AddToProcessorMap("TestObj", &echoServerProcessorTestObj{handler: handler})
	return self
}
...
type echoServerProcessorTestObj struct {
	handler EchoServer
}

func (p *echoServerProcessorTestObj) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := EchoServerTestObjArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := EchoServerTestObjResult{}
	var retval *ObjResp
