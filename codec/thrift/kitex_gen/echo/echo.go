...
type StreamServer interface {
	Echo(stream StreamServer_EchoServer) (err error)
}

type StreamServer_EchoServer interface {
	streaming.Stream
...
type StreamServerEchoArgs struct {
	Req *Request `thrift:"req,1" frugal:"1,default,Request" json:"req"`
}

func NewStreamServerEchoArgs() *StreamServerEchoArgs {
	return &StreamServerEchoArgs{}
}

func (p *StreamServerEchoArgs) InitDefault() {
}

var StreamServerEchoArgs_Req_DEFAULT *Request

func (p *StreamServerEchoArgs) GetReq() (v *Request) {
	if !p.IsSetReq() {
		return StreamServerEchoArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *StreamServerEchoArgs) SetReq(val *Request) {
	p.Req = val
}

var fieldIDToName_StreamServerEchoArgs = map[int16]string{
	1: "req",
}

func (p *StreamServerEchoArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *StreamServerEchoArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_StreamServerEchoArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *StreamServerEchoArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := NewRequest()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *StreamServerEchoArgs) Write(oprot thrift.TProtocol) (err error) {
...
func (p *StreamServerEchoArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *StreamServerEchoArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("StreamServerEchoArgs(%+v)", *p)

}

func (p *StreamServerEchoArgs) DeepEqual(ano *StreamServerEchoArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *StreamServerEchoArgs) Field1DeepEqual(src *Request) bool {
...
type StreamServerEchoResult struct {
	Success *Response `thrift:"success,0,optional" frugal:"0,optional,Response" json:"success,omitempty"`
}

func NewStreamServerEchoResult() *StreamServerEchoResult {
	return &StreamServerEchoResult{}
}

func (p *StreamServerEchoResult) InitDefault() {
}

var StreamServerEchoResult_Success_DEFAULT *Response

func (p *StreamServerEchoResult) GetSuccess() (v *Response) {
	if !p.IsSetSuccess() {
		return StreamServerEchoResult_Success_DEFAULT
	}
	return p.Success
}
func (p *StreamServerEchoResult) SetSuccess(x interface{}) {
	p.Success = x.(*Response)
}

var fieldIDToName_StreamServerEchoResult = map[int16]string{
	0: "success",
}

func (p *StreamServerEchoResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *StreamServerEchoResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_StreamServerEchoResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *StreamServerEchoResult) ReadField0(iprot thrift.TProtocol) error {
	_field := NewResponse()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *StreamServerEchoResult) Write(oprot thrift.TProtocol) (err error) {
...
func (p *StreamServerEchoResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *StreamServerEchoResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("StreamServerEchoResult(%+v)", *p)

}

func (p *StreamServerEchoResult) DeepEqual(ano *StreamServerEchoResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *StreamServerEchoResult) Field0DeepEqual(src *Response) bool {
