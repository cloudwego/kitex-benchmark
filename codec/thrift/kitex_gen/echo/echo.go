...
type LargeMessage struct {
	Action string              `thrift:"action,1,required" frugal:"1,required,string" json:"action"`
	Msg    string              `thrift:"msg,2,required" frugal:"2,required,string" json:"msg"`
	Map    map[string]*Message `thrift:"map,3,required" frugal:"3,required,map<string:Message>" json:"map"`
	List   []*Message          `thrift:"list,4,required" frugal:"4,required,list<Message>" json:"list"`
	Set    []*Message          `thrift:"set,5,optional" frugal:"5,optional,set<Message>" json:"set,omitempty"`
}

func NewLargeMessage() *LargeMessage {
	return &LargeMessage{}
}

func (p *LargeMessage) InitDefault() {
	*p = LargeMessage{}
}

func (p *LargeMessage) GetAction() (v string) {
	return p.Action
}

func (p *LargeMessage) GetMsg() (v string) {
	return p.Msg
}

func (p *LargeMessage) GetMap() (v map[string]*Message) {
	return p.Map
}

func (p *LargeMessage) GetList() (v []*Message) {
	return p.List
}

var LargeMessage_Set_DEFAULT []*Message

func (p *LargeMessage) GetSet() (v []*Message) {
	if !p.IsSetSet() {
		return LargeMessage_Set_DEFAULT
	}
	return p.Set
}
func (p *LargeMessage) SetAction(val string) {
	p.Action = val
}
func (p *LargeMessage) SetMsg(val string) {
	p.Msg = val
}
func (p *LargeMessage) SetMap(val map[string]*Message) {
	p.Map = val
}
func (p *LargeMessage) SetList(val []*Message) {
	p.List = val
}
func (p *LargeMessage) SetSet(val []*Message) {
	p.Set = val
}

var fieldIDToName_LargeMessage = map[int16]string{
	1: "action",
	2: "msg",
	3: "map",
	4: "list",
...
func (p *LargeMessage) IsSetSet() bool {
	return p.Set != nil
}

func (p *LargeMessage) Read(iprot thrift.TProtocol) (err error) {

	var fieldTypeId thrift.TType
	var fieldId int16
	var issetAction bool = false
	var issetMsg bool = false
	var issetMap bool = false
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_LargeMessage[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
ReadStructEndError:
	return thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_LargeMessage[fieldId]))
}

func (p *LargeMessage) ReadField1(iprot thrift.TProtocol) error {
...
func (p *LargeMessage) ReadField2(iprot thrift.TProtocol) error {
...
func (p *LargeMessage) ReadField3(iprot thrift.TProtocol) error {
...
func (p *LargeMessage) ReadField4(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return err
	}
...
func (p *LargeMessage) ReadField5(iprot thrift.TProtocol) error {
...
func (p *LargeMessage) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("LargeMessage"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *LargeMessage) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("action", thrift.STRING, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Action); err != nil {
...
func (p *LargeMessage) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("msg", thrift.STRING, 2); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Msg); err != nil {
...
func (p *LargeMessage) writeField3(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("map", thrift.MAP, 3); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteMapBegin(thrift.STRING, thrift.STRUCT, len(p.Map)); err != nil {
		return err
	}
	for k, v := range p.Map {
...
func (p *LargeMessage) writeField4(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("list", thrift.LIST, 4); err != nil {
		goto WriteFieldBeginError
	}
...
func (p *LargeMessage) writeField5(oprot thrift.TProtocol) (err error) {
	if p.IsSetSet() {
		if err = oprot.WriteFieldBegin("set", thrift.SET, 5); err != nil {
			goto WriteFieldBeginError
		}
		if err := oprot.WriteSetBegin(thrift.STRUCT, len(p.Set)); err != nil {
			return err
		}
...
func (p *LargeMessage) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("LargeMessage(%+v)", *p)

}

func (p *LargeMessage) DeepEqual(ano *LargeMessage) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
	...
	if !p.Field3DeepEqual(ano.Map) {
		return false
	}
	if !p.Field4DeepEqual(ano.List) {
		return false
	}
	if !p.Field5DeepEqual(ano.Set) {
		return false
	}
	return true
}

func (p *LargeMessage) Field1DeepEqual(src string) bool {
...
func (p *LargeMessage) Field2DeepEqual(src string) bool {
...
func (p *LargeMessage) Field3DeepEqual(src map[string]*Message) bool {
...
func (p *LargeMessage) Field4DeepEqual(src []*Message) bool {
...
func (p *LargeMessage) Field5DeepEqual(src []*Message) bool {
...
type EchoServer interface {
	...
	EchoLarge(ctx context.Context, msg *LargeMessage) (r *LargeMessage, err error)
...
type EchoServerEchoLargeArgs struct {
	Msg *LargeMessage `thrift:"msg,1" frugal:"1,default,LargeMessage" json:"msg"`
}

func NewEchoServerEchoLargeArgs() *EchoServerEchoLargeArgs {
	return &EchoServerEchoLargeArgs{}
}

func (p *EchoServerEchoLargeArgs) InitDefault() {
	*p = EchoServerEchoLargeArgs{}
}

var EchoServerEchoLargeArgs_Msg_DEFAULT *LargeMessage

func (p *EchoServerEchoLargeArgs) GetMsg() (v *LargeMessage) {
	if !p.IsSetMsg() {
		return EchoServerEchoLargeArgs_Msg_DEFAULT
	}
	return p.Msg
}
func (p *EchoServerEchoLargeArgs) SetMsg(val *LargeMessage) {
	p.Msg = val
}

var fieldIDToName_EchoServerEchoLargeArgs = map[int16]string{
	1: "msg",
}

func (p *EchoServerEchoLargeArgs) IsSetMsg() bool {
	return p.Msg != nil
}

func (p *EchoServerEchoLargeArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_EchoServerEchoLargeArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *EchoServerEchoLargeArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := NewLargeMessage()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Msg = _field
...
func (p *EchoServerEchoLargeArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("EchoLarge_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *EchoServerEchoLargeArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *EchoServerEchoLargeArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("EchoServerEchoLargeArgs(%+v)", *p)

}

func (p *EchoServerEchoLargeArgs) DeepEqual(ano *EchoServerEchoLargeArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *EchoServerEchoLargeArgs) Field1DeepEqual(src *LargeMessage) bool {
...
type EchoServerEchoLargeResult struct {
	Success *LargeMessage `thrift:"success,0,optional" frugal:"0,optional,LargeMessage" json:"success,omitempty"`
}

func NewEchoServerEchoLargeResult() *EchoServerEchoLargeResult {
	return &EchoServerEchoLargeResult{}
}

func (p *EchoServerEchoLargeResult) InitDefault() {
	*p = EchoServerEchoLargeResult{}
}

var EchoServerEchoLargeResult_Success_DEFAULT *LargeMessage

func (p *EchoServerEchoLargeResult) GetSuccess() (v *LargeMessage) {
	if !p.IsSetSuccess() {
		return EchoServerEchoLargeResult_Success_DEFAULT
	}
	return p.Success
}
func (p *EchoServerEchoLargeResult) SetSuccess(x interface{}) {
	p.Success = x.(*LargeMessage)
}

var fieldIDToName_EchoServerEchoLargeResult = map[int16]string{
	0: "success",
}

func (p *EchoServerEchoLargeResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *EchoServerEchoLargeResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_EchoServerEchoLargeResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *EchoServerEchoLargeResult) ReadField0(iprot thrift.TProtocol) error {
	_field := NewLargeMessage()
	if err := _field.Read(iprot); err != nil {
		return err
	}
...
func (p *EchoServerEchoLargeResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("EchoLarge_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *EchoServerEchoLargeResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *EchoServerEchoLargeResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("EchoServerEchoLargeResult(%+v)", *p)

}

func (p *EchoServerEchoLargeResult) DeepEqual(ano *EchoServerEchoLargeResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *EchoServerEchoLargeResult) Field0DeepEqual(src *LargeMessage) bool {
