...
type Client interface {
	...
	NestedEcho(ctx context.Context, req *echo.NestedRequest, callOptions ...callopt.Option) (r *echo.NestedResponse, err error)
}
...
func (p *kEchoServerClient) NestedEcho(ctx context.Context, req *echo.NestedRequest, callOptions ...callopt.Option) (r *echo.NestedResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.NestedEcho(ctx, req)
}
