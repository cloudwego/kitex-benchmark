...
func NewServer(handler StreamServer, opts ...server.Option) server.Server {
...
func RegisterService(svr server.Server, handler StreamServer, opts ...server.RegisterOption) error {
