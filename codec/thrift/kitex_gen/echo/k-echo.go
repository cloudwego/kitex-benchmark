...
func (p *LargeMessage) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_LargeMessage[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
ReadStructEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read struct end error: ", p), err)
RequiredFieldNotSetError:
	return offset, thrift.NewTProtocolExceptionWithType(thrift.INVALID_DATA, fmt.Errorf("required field %s is not set", fieldIDToName_LargeMessage[fieldId]))
}

func (p *LargeMessage) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
func (p *LargeMessage) FastReadField2(buf []byte) (int, error) {
	offset := 0
...
func (p *LargeMessage) FastReadField3(buf []byte) (int, error) {
	offset := 0
...
func (p *LargeMessage) FastReadField4(buf []byte) (int, error) {
	offset := 0
	_, size, l, err := bthrift.Binary.ReadListBegin(buf[offset:])
	offset += l
	if err != nil {
...
func (p *LargeMessage) FastReadField5(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *LargeMessage) FastWrite(buf []byte) int {
	return 0
}

func (p *LargeMessage) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "LargeMessage")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
		offset += p.fastWriteField2(buf[offset:], binaryWriter)
		offset += p.fastWriteField3(buf[offset:], binaryWriter)
...
func (p *LargeMessage) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("LargeMessage")
	if p != nil {
		l += p.field1Length()
		l += p.field2Length()
		l += p.field3Length()
...
func (p *LargeMessage) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "action", thrift.STRING, 1)
	offset += bthrift.Binary.WriteStringNocopy(buf[offset:], binaryWriter, p.Action)
...
func (p *LargeMessage) fastWriteField2(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "msg", thrift.STRING, 2)
	offset += bthrift.Binary.WriteStringNocopy(buf[offset:], binaryWriter, p.Msg)
...
func (p *LargeMessage) fastWriteField3(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "map", thrift.MAP, 3)
...
func (p *LargeMessage) fastWriteField4(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "list", thrift.LIST, 4)
	listBeginOffset := offset
	offset += bthrift.Binary.ListBeginLength(thrift.STRUCT, 0)
	var length int
...
func (p *LargeMessage) fastWriteField5(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetSet() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "set", thrift.SET, 5)
...
func (p *LargeMessage) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("action", thrift.STRING, 1)
	l += bthrift.Binary.StringLengthNocopy(p.Action)
...
func (p *LargeMessage) field2Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("msg", thrift.STRING, 2)
	l += bthrift.Binary.StringLengthNocopy(p.Msg)
...
func (p *LargeMessage) field3Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("map", thrift.MAP, 3)
	l += bthrift.Binary.MapBeginLength(thrift.STRING, thrift.STRUCT, len(p.Map))
	for k, v := range p.Map {
...
func (p *LargeMessage) field4Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("list", thrift.LIST, 4)
...
func (p *LargeMessage) field5Length() int {
	l := 0
	if p.IsSetSet() {
		l += bthrift.Binary.FieldBeginLength("set", thrift.SET, 5)
		l += bthrift.Binary.SetBeginLength(thrift.STRUCT, len(p.Set))
...
func (p *EchoServerEchoLargeArgs) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_EchoServerEchoLargeArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *EchoServerEchoLargeArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
...
// for compatibility
func (p *EchoServerEchoLargeArgs) FastWrite(buf []byte) int {
	return 0
}

func (p *EchoServerEchoLargeArgs) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "EchoLarge_args")
	if p != nil {
		offset += p.fastWriteField1(buf[offset:], binaryWriter)
	}
	offset += bthrift.Binary.WriteFieldStop(buf[offset:])
...
func (p *EchoServerEchoLargeArgs) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("EchoLarge_args")
	if p != nil {
		l += p.field1Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *EchoServerEchoLargeArgs) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *EchoServerEchoLargeArgs) field1Length() int {
	l := 0
...
func (p *EchoServerEchoLargeResult) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_EchoServerEchoLargeResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *EchoServerEchoLargeResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
	_field := NewLargeMessage()
	if l, err := _field.FastRead(buf[offset:]); err != nil {
		return offset, err
...
// for compatibility
func (p *EchoServerEchoLargeResult) FastWrite(buf []byte) int {
	return 0
}

func (p *EchoServerEchoLargeResult) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteStructBegin(buf[offset:], "EchoLarge_result")
	if p != nil {
		offset += p.fastWriteField0(buf[offset:], binaryWriter)
	}
	offset += bthrift.Binary.WriteFieldStop(buf[offset:])
...
func (p *EchoServerEchoLargeResult) BLength() int {
	l := 0
	l += bthrift.Binary.StructBeginLength("EchoLarge_result")
	if p != nil {
		l += p.field0Length()
	}
	l += bthrift.Binary.FieldStopLength()
...
func (p *EchoServerEchoLargeResult) fastWriteField0(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetSuccess() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "success", thrift.STRUCT, 0)
		offset += p.Success.FastWriteNocopy(buf[offset:], binaryWriter)
...
func (p *EchoServerEchoLargeResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
		l += bthrift.Binary.FieldBeginLength("success", thrift.STRUCT, 0)
		l += p.Success.BLength()
...
func (p *EchoServerTestObjArgs) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_EchoServerTestObjArgs[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *EchoServerTestObjArgs) FastReadField1(buf []byte) (int, error) {
	offset := 0
	_field := NewObjReq()
	if l, err := _field.FastRead(buf[offset:]); err != nil {
		return offset, err
...
// for compatibility
func (p *EchoServerTestObjArgs) FastWrite(buf []byte) int {
	return 0
}

func (p *EchoServerTestObjArgs) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *EchoServerTestObjArgs) BLength() int {
	l := 0
...
func (p *EchoServerTestObjArgs) fastWriteField1(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "req", thrift.STRUCT, 1)
	offset += p.Req.FastWriteNocopy(buf[offset:], binaryWriter)
	offset += bthrift.Binary.WriteFieldEnd(buf[offset:])
...
func (p *EchoServerTestObjArgs) field1Length() int {
	l := 0
	l += bthrift.Binary.FieldBeginLength("req", thrift.STRUCT, 1)
	l += p.Req.BLength()
	l += bthrift.Binary.FieldEndLength()
...
func (p *EchoServerTestObjResult) FastRead(buf []byte) (int, error) {
	var err error
	var offset int
	var l int
	var fieldTypeId thrift.TType
...
ReadFieldBeginError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_EchoServerTestObjResult[fieldId]), err)
SkipFieldError:
	return offset, thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
ReadFieldEndError:
	return offset, thrift.PrependError(fmt.Sprintf("%T read field end error", p), err)
...
func (p *EchoServerTestObjResult) FastReadField0(buf []byte) (int, error) {
	offset := 0
	_field := NewObjResp()
	if l, err := _field.FastRead(buf[offset:]); err != nil {
		return offset, err
...
// for compatibility
func (p *EchoServerTestObjResult) FastWrite(buf []byte) int {
	return 0
}

func (p *EchoServerTestObjResult) FastWriteNocopy(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
...
func (p *EchoServerTestObjResult) BLength() int {
	l := 0
...
func (p *EchoServerTestObjResult) fastWriteField0(buf []byte, binaryWriter bthrift.BinaryWriter) int {
	offset := 0
	if p.IsSetSuccess() {
		offset += bthrift.Binary.WriteFieldBegin(buf[offset:], "success", thrift.STRUCT, 0)
		offset += p.Success.FastWriteNocopy(buf[offset:], binaryWriter)
...
func (p *EchoServerTestObjResult) field0Length() int {
	l := 0
	if p.IsSetSuccess() {
		l += bthrift.Binary.FieldBeginLength("success", thrift.STRUCT, 0)
		l += p.Success.BLength()
...
func (p *EchoServerEchoLargeArgs) GetFirstArgument() interface{} {
	return p.Msg
}

func (p *EchoServerEchoLargeResult) GetResult() interface{} {
	return p.Success
}

func (p *EchoServerTestObjArgs) GetFirstArgument() interface{} {
	return p.Req
}

func (p *EchoServerTestObjResult) GetResult() interface{} {
	return p.Success
}
